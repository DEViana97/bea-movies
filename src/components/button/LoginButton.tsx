...
const LoginButton = ({handleSubmit}: LoginButtonProps) => {
  return (
    <StyledWrapper onClick={handleSubmit}>
      <div className="btn-conteiner">
        <span className="btn-content">
          <span className="btn-title">Entrar</span>
          <span className="icon-arrow">
            <svg width="24px" height="24px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
